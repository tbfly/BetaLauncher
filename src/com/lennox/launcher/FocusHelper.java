...
public class FocusHelper {
    ...
    static boolean handleIconKeyEvent(View v, int keyCode, KeyEvent e) {
        ...
        boolean tabletSearchBar = PreferencesProvider.Interface.Homescreen.getTabletSearchBar();
        int searchBar = tabletSearchBar ? R.id.qsb_bar_dock : R.id.qsb_bar;
        final ViewGroup tabs = (ViewGroup) launcher.findViewById(searchBar);
