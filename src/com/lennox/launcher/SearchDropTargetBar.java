...
public class SearchDropTargetBar extends FrameLayout implements DragController.DragListener {
    ...
    static final int BACKGROUND_JELLYBEAN = 0;
    static final int BACKGROUND_ICS = 1;
    static final int BACKGROUND_MIUI = 2;
    static final int BACKGROUND_DIVIDER = 3;
    static final int BACKGROUND_NONE = 4;
    ...
    public SearchDropTargetBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        mShowQSBSearchBar = PreferencesProvider.Interface.Homescreen.getShowSearchBar(
                                           LauncherApplication.isScreenLandscape(context));
    ...
    protected void onFinishInflate() {
        ...
        switch (mSearchBarBackground) {
            case BACKGROUND_MIUI:
                background = R.drawable.search_frame_miui;
                break;
            case BACKGROUND_ICS:
        ...
        if (background != 0) mQSBSearchBar.setBackgroundResource(background);
