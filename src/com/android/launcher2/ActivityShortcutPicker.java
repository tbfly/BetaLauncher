...
public class ActivityShortcutPicker extends ListActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mIconCache = ((LauncherApplication) getApplicationContext()).getIconCache();
    ...
    public void onListItemClick(ListView parentView, View view, int which, long id) {
