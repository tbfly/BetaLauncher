...
public class InstallShortcutReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent data) {
        if (!PreferencesProvider.Interface.Homescreen.getAllowShortcuts()) {
            return;
        }
    ...
    private static void processInstallShortcut(Context context,
        ...
        synchronized (app) {
            ...
            final boolean isLandscape = LauncherApplication.isScreenLandscape(context);
            final int screenCount = PreferencesProvider.Interface.Homescreen.getNumberHomescreens(isLandscape);
            final int screenDefault = PreferencesProvider.Interface.Homescreen.getDefaultHomescreen(screenCount / 2, isLandscape);
